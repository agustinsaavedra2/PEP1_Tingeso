        ...
        <form>
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                    id="formGroupExampleInput" placeholder="Enter name" value={nameBooking} onChange={(e) => setNameBooking(e.target.value)}/>
            </div>
            
            <div className="form-group">
                <label htmlFor="formGroupExampleInput2">Laps Number</label>
                <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="Ej: 10, 15, 20" value={lapsNumber} onChange={(e) => setLapsNumber(e.target.value)}/>
            </div>

            <div className="form-group">
                <label htmlFor="formGroupExampleInput3">Maximum Time</label>
                <input type="text" className="form-control" id="formGroupExampleInput3" placeholder="Ej: 10, 20, 30" value={maximumTime} onChange={(e) => setMaximumTime(e.target.value)}/>
            </div>

            <div className="form-group">
                <label htmlFor="formGroupExampleInput4">Booking Date</label>
                <input type="date" className="form-control" id="formGroupExampleInput4" placeholder="Ej: 2025-4-23" value={bookingDate} onChange={(e) => setBookingDate(e.target.value)}/>
            </div>

            <div className="form-group">
                <label htmlFor="formGroupExampleInput5">Booking Time</label>
                <input type="time" className="form-control" id="formGroupExampleInput5" placeholder="Ej: 18:36" value={bookingTime} onChange={(e) => setBookingTime(e.target.value)}/>
            </div>

            <div className="form-group">
                <label htmlFor="formGroupExampleInput6">List Clients</label>
                <input type="text" className="form-control" id="formGroupExampleInput6" placeholder="Ej: [Agustín, Carlos]" value={clients} onChange={(e) => setClients(e.target.value)}/>
            </div>
